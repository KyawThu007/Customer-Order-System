       ...
       Adminprocess.
           MOVE "1" TO EOFP
            PERFORM UNTIL EOFP = "0"
               ...
               display "Stock"
               DISPLAY H10 H10 H10 H5
               DISPLAY "7. Low Stock" S1 Low-Stock-Count
      ...
      *>          MOVE FUNCTION UPPER-CASE(EOFP) TO EOFP
       ...
       sale.
               ...
               NOT AT END
                   ...
                   IF Sale-ID = Sale-Input-ID
                      ...
                      Sale-PW = Sale-Input-Password
                       MOVE "Y" TO EF
                       MOVE "Y" TO ACCESSS
                       MOVE 'N' TO Sale-Input-ID
                       MOVE 'N' TO Sale-Input-Password
                       EXIT PERFORM
                   END-IF
           ...
           IF ACCESSS = "Y"
             DISPLAY H10 H10 H10 H8
             DISPLAY "Login successful. Welcome, " Sale-ID
             PERFORM Saleprocess
           ELSE
               DISPLAY "Login failed.Login try again!!!!!"
               MOVE 'N' TO Sale-Input-ID
      ...
      *>          MOVE FUNCTION UPPER-CASE(EOFP) TO EOFP
       ...
       Add-Discount.
            ...
            PERFORM UNTIL EOF = "0"
               ...
               IF File-Status = "00"
                   DISPLAY "Discount added successfully."
               ELSE
                   DISPLAY "File Status: " File-Status
               END-IF
               DISPLAY "1.Add more data"
           ...
           OPEN I-O DiscountFile
            ...
            NOT INVALID KEY
                IF File-Status = "00"
                   ...
                   IF File-Status = "00"
                       DISPLAY "Discount updated successfully."
                   ELSE
                       DISPLAY "File Status: " File-Status
                   END-IF
                END-IF
       ...
       Delete-Discount.
           OPEN I-O DiscountFile
            ...
            NOT INVALID KEY
               IF File-Status = "00"
                   DISPLAY "Discount deleted successfully."
               ELSE
                   DISPLAY "File Status: " File-Status
               END-IF
            END-DELETE
       ...
       Cart.
            ...
            PERFORM UNTIL EOFP = "0"
              PERFORM Buy-Cart
              DISPLAY "1.Add More Cart"
              DISPLAY "2.Buy"
              DISPLAY "3.Update Quantity"
              DISPLAY "4.Delete Cart"
              DISPLAY "0.Go Back"
               DISPLAY "Enter Choose Option:"
               ACCEPT User-Choice
               EVALUATE User-Choice
       ...
       Add-Cart.
            ...
            NOT INVALID KEY
                IF File-Status = "00"
                   ...
                   END-WRITE
                   IF File-Status = "00"
                       DISPLAY "Added Cart successfully."
                   ELSE
                       DISPLAY "File Status: " File-Status
                   END-IF
                   END-IF
       ...
       Update-Cart-Quantity.
            ...
            NOT INVALID KEY
               IF File-Status = "00"
                   ...
                   IF File-Status = "00"
                       DISPLAY "Cart updated successfully."
                   ELSE
                       DISPLAY "File Status: " File-Status
                   END-IF
                END-IF
       ...
       Delete-Cart.
            ...
            NOT INVALID KEY
               IF File-Status = "00"
                   DISPLAY "Cart deleted successfully."
               ELSE
                   DISPLAY "File Status: " File-Status
               END-IF
            END-DELETE
      ...
      *>      Update Quantity
                ...
                COMPUTE Total= Total+
                   (Sale-Cart-Quantity*Sale-Cart-Unit-Of-Price)
       ...
       Invoice-Confirm.
            ...
            NOT INVALID KEY
                IF File-Status = "00"
                   ...
                   IF File-Status = "00"
                       DISPLAY "Invoice Completed successfully."
                   ELSE
                       DISPLAY "File Status: " File-Status
                   END-IF
                END-IF
